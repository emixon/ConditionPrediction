...
\item Build a prediction model returnig multi-class distribution using XGBoost (or other decision tree library) trained on identified principal components.
